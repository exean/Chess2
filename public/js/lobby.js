(function () {
  ...
  function shapeHintText(s) {
    ...
    if (s === 'hole') return 'Loch 8x8: zentrales 2×2-Loch (d4/d5/e4/e5). Figuren können nicht über das Loch hinweg ziehen, Bauern müssen es per Diagonalschlag oder über die Flanken umlaufen. Umwandlung erst auf der gegnerischen Grundreihe. Unbewertet.';
